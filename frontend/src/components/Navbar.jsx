...
const Navbar = () => {
    ...
    const logout =()=>{ // to logout the user
       navigate('/login'); // redirect the user to login page
      localStorage.removeItem('token'); // remove token from localStorage
      setToken(''); // make the set token empty so that the user is logged out
      setCartItems({}); // make the cart items empty so that the user is logged out
